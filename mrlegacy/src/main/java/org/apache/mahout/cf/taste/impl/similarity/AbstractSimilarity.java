...
abstract class AbstractSimilarity extends AbstractItemSimilarity implements UserSimilarity { //wxc pro 2015-02-05 16:34:37 继承自AbstractItemSimilarity，而再实现接口UserSimilarity应该是有特殊考虑的？也就是轻UserSimilarity而重ItemSimilarity？ 不过， 跟相若相关的两个元素关联起来了。 一块露面了。有个基本的根据地。
